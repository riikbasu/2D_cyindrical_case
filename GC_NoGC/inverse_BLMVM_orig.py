...
#                    m_misfit += assemble(conditional(abs(M_clusters - M_c) < eps, T - T_melt, 0.0) * dx) ** 2
    ...
    functional_file = "functional_TAO_LS_BLMVM.txt"
    solutions_vtk = VTKFile("solutions_TAO_LS_BLMVM.pvd")
    ...
    solver = TAOSolver(minimisation_problem, {
        ...
        "tao_lmm_scale_type": "diagonal",              # Initial Hessian scaling ('none'|'scalar'|'diagonal'); default: 'scalar'
