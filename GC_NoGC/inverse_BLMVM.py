...
#                    m_misfit += assemble(conditional(abs(M_clusters - M_c) < eps, T - T_melt, 0.0) * dx) ** 2
    ...
    functional_file = "functional_TAO_LS_LMVM_orig.txt"
    solutions_vtk = VTKFile("solutions_TAO_LS_LMVM_orig.pvd")
    ...
    solver = TAOSolver(minimisation_problem, {
        ...
        # -------------------------------------------------------
        "tao_type": "lmvm",                         # Use BLMVM algorithm (L-BFGS with bounds); default: nls
